...
if(Scancount>16000){ Scancount=0;NEW_SERIAL_PROTOCOLPGM("J10");TFT_SERIAL_ENTER();

	  }//T0 unnormal  //2019.4.19
}
...
inline void gcode_M109() {
  ...
  do {
	...
	//if(thermalManager.isCoolingHotend(target_extruder))break;
  ...
  inline void gcode_M190() {
    ...
    do {
      ...
      if (theTarget != thermalManager.degTargetBed()) {
	   ...
	   //if(thermalManager.isCoolingBed())break;
